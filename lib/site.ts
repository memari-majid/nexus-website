...
export const SITE = {
   ...
   */
  description:
    "Nexus AI Solutions provides AI consulting and training — NVIDIA Deep Learning Institute workshops hosted by a Certified Instructor for industry teams, and taught free on US campuses through the University Ambassador Program, plus custom training designed around your team. Founded by Majid Memari, AI Scientist and Solution Architect.",
