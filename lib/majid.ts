 ...
 * Name style is postnominal only, "Majid Memari, PhD". Never combine a "Dr."
...
export const MAJID = {
  ...
  education: {
    ...
    phdResearch:
      "Doctoral research in generative AI, using conditional VAE and GAN models for synthetic-image generation and evaluation",
  ...
  prior: {
    /**
     * A 2023 to 2024 postdoc at his current university employer also exists.
     * It is deliberately not stored as publishable copy here: naming it would
     * name the employer this site omits. Do not add it back as a string.
     */
    ...
    siu: "Research Assistant, Southern Illinois University Carbondale (2015 to 2022)",
  },
  /**
   ...
   * presented as a Nexus sponsor. Academia leads with LLMs, the present-day
   * work and what Nexus sells, with the doctoral generative-AI research
   * behind it. Keep the Penn-appointment / Stanford-and-JHU-collaboration
   * distinction intact in any rewrite.
   */
  bio: {
    academia:
