...
- workshop: workshops, team training, in-house training, NVIDIA DLI generative AI workshops for industry or academia (the "Building Agentic AI Applications With LLMs" workshop — NVIDIA takes care of everything: cloud GPU VMs so the customer needs no compute, plus pricing/purchase, content, curriculum, assessment, and certificate; Nexus only hosts and teaches in person or online and has no control over price or content; seats are purchased through NVIDIA), custom-designed training, campus invitations (US universities get the NVIDIA DLI workshop free with six weeks' notice)
